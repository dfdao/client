...
import { SpaceType, PlanetType } from 'https://cdn.skypack.dev/@dfdao/types';
...
class UpgradeManager {
  async render(container) {
    ...
    upgradePlanetsButton.onclick = () => {
      ...
      upgradePlanetsButton.innerText = upgradingToggle ? 'Start Upgrading!' : 'Stop Upgrading';
    };

    container.append(tutorial, patternLabel, patternInput, upgradePlanetsButton);
    patternInput.focus();
  }
